...
sudo dd if=/media/pi/BigOne/mmcblk0boot0_backup.img of=/dev/mmcblk0boot0 bs=4M status=progress
sudo dd if=/media/pi/BigOne/mmcblk0boot1_backup.img of=/dev/mmcblk0boot1 bs=4M status=progress
sudo dd if=/media/pi/BigOne/mmcblk0rpmb_backup.img of=/dev/mmcblk0rpmb bs=4M status=progress
```
# Setup
